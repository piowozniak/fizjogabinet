...
<body onload='document.loginForm.username.focus();'>
	...
	<f:form method="POST" action="${contextPath}/changePassword" modelAttribute="passwordForm" class="form-signin">
		<spring:bind path="currentPassword">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<f:input type="password" path="currentPassword" class="form-control"
					placeholder="Current password" autofocus="true"></f:input>
